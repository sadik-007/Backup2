...
namespace ProjectPP
{
    public partial class Salesmanproductentry : Form
    {
        ...
        public Salesmanproductentry()
        {
            InitializeComponent();
        }

        private void Salesproductentry_Load(object sender, EventArgs e)
        {
        ...
        {
            Salesmanproductentry salesmanproductentry = new Salesmanproductentry();
            salesmanproductentry.Show();
            this.Hide();
        }
    }
}